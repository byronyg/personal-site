# no style, or whatever frech montana said!

A (nearly) no-CSS, fast, minimalist [Jekyll](https://jekyllrb.com/) theme.
Inspired by [elly's site](http://tilde.town/~elly/), expressly created for [my personal blog](https://byron.wtf/).
...
A so-called archive page is a page that shows a list of posts  for an example). You can create an archive page by creating a page and putting the following frontmatter:
...
Bug reports and pull requests are welcome on GitHub at https://github.com/byronyg/personal-site. This project is intended to be a safe, welcoming space for collaboration, and contributors are expected to adhere to the [Contributor Covenant](http://contributor-covenant.org) code of conduct.
